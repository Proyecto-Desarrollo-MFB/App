...
public class WishTripDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        WishTripGlobalFeatureConfigurator.Configure();
        WishTripModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<WishTripDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<WishTripResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/WishTrip");

            options.DefaultResourceType = typeof(WishTripResource);
        ...
        {
            options.MapCodeNamespace("WishTrip", typeof(WishTripResource));
        });
    }
}
